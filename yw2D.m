function [psd,f,kvec]=yw2D(yin,varargin)

%This function evaluates the time-space spectrum of a two dimensional
%input signal using the Yule-Walker algorithm.
%The YW algorithm is used to handle unevenly sampled data.
%
% INPUTS:
%
...
%    quiet    : if equal to 1, do not display information. Display if equal to 0 [Default, 0]
%
% OUTPUTS:
%
...
defaults={[1:n2],n2,4096,4096,2048,4e6,0};
variab={'xin','kvec','nwind','nfft','nov','fs','quiet'};
